  ...
  <div class="container">
    ...
    <div class="navbar-collapse collapse" id="navbar">
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="dropdown">
        	<a aria-expanded="false" aria-haspopup="true" role="button" data-toggle="dropdown" class="dropdown-toggle" href="#">Idioma<span class="caret"></span></a>
	          <ul class="dropdown-menu">
	            <li><span><img alt="Brand" src="<c:url value='/resources/img/colombia32.png' />"><a href="?lang=es">Espa&ntildeol</a></span></li>
	            <li><span><img alt="Brand" src="<c:url value='/resources/img/australia32.png' />"><a href="?lang=en">English</a></span></li>
	          </ul>
        </li>
      </ul>
    </div><!--/.nav-collapse -->
...
<div id="content" class="banner">
	<div class="container">
		...
		<h1>Horus</h1>
		<p>Estamos construyendo un software increible...</p>
